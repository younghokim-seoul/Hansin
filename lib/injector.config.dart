...
import 'package:hansin/feature/show_room/show_room_reservation_view_model.dart'
    as _i10;
import 'package:hansin/feature/sign_up/sign_up_view_model.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.ReservationRegisterViewModel>(
        () => _i9.ReservationRegisterViewModel(gh<_i5.ItemRepository>()));
    gh.factory<_i10.ShowRoomReservationViewModel>(
        () => _i10.ShowRoomReservationViewModel(gh<_i5.ItemRepository>()));
    gh.factory<_i11.SignUpViewModel>(
        () => _i11.SignUpViewModel(gh<_i5.ItemRepository>()));
    gh.factory<_i12.VerificationModel>(
        () => _i12.VerificationModel(gh<_i5.ItemRepository>()));
    return this;
  }
}
